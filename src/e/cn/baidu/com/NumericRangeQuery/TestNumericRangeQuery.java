package e.cn.baidu.com.NumericRangeQuery;
...
public class TestNumericRangeQuery {
	...
	public void termQuery() throws Exception {
		...
		Query quer = new TermQuery(new Term("name", "java"));
		// 7.指定查询条件
		// Query quer = query.parse("name:java");
		// Query query = NumericRangeQuery.newFloatRange("price", 54f, 56f,
		// false, true);
